...
function cespba(){
    ...
    suma=0;
    k1=document.getElementById("km1").value;
    if(k1!=""){suma=suma+parseFloat(k1);};
    k2=document.getElementById("km2").value;
    if(k2!=""){suma=suma+parseFloat(k2);};
    k3=document.getElementById("km3").value;
    if(k3!=""){suma=suma+parseFloat(k3);};
    k4=document.getElementById("km4").value;
    if(k4!=""){suma=suma+parseFloat(k4);};
    
    //document.getElementById("dis_total").value=Math.ceil(suma,2);
    document.getElementById("dis_total").value=suma.toFixed(2);

}

function distancias(){
    kmt=0;
    vpar=document.getElementById("partida").value;
    vds1=document.getElementById("destino_1").value;
    vds2=document.getElementById("destino_2").value;
    vds3=document.getElementById("destino_3").value;
    vds4=document.getElementById("destino_4").value;
    document.getElementById('p_desde1').innerHTML=vpar;
    document.getElementById('p_hasta1').innerHTML=vds1;
    document.getElementById('p_desde2').innerHTML="";
    document.getElementById('p_hasta2').innerHTML="";
    document.getElementById('p_desde3').innerHTML="";
    document.getElementById('p_hasta3').innerHTML="";
    document.getElementById('p_desde4').innerHTML="";
    document.getElementById('p_hasta4').innerHTML="";
    document.getElementById("km1").value=eje("vl_distancia?pd="+vpar+"&ph="+vds1);
    if(vds1!="" && vds2!="") {
       document.getElementById('p_desde2').innerHTML=vds1;
       document.getElementById('p_hasta2').innerHTML=vds2;
       document.getElementById("km2").value=eje("vl_distancia?pd="+vds1+"&ph="+vds2);
    }
    if(vds2!="" && vds3!="") {
       document.getElementById('p_desde3').innerHTML=vds2;
       document.getElementById('p_hasta3').innerHTML=vds3;
       document.getElementById("km3").value=eje("vl_distancia?pd="+vds2+"&ph="+vds3);
    }
    if(vds3!="" && vds4!="") {
       document.getElementById('p_desde4').innerHTML=vds3;
       document.getElementById('p_hasta4').innerHTML=vds4;
       document.getElementById("km4").value=eje("vl_distancia?pd="+vds3+"&ph="+vds4);
    }
...
function guarda_distancias(){
  if(document.getElementById("km1").value!="") {guarda_distancia("1");};
  if(document.getElementById("km2").value!="") {guarda_distancia("2");};
  if(document.getElementById("km3").value!="") {guarda_distancia("3");};
  if(document.getElementById("km4").value!="") {guarda_distancia("4");};
  return true;
}
function guarda_distancia(orden){
  km=document.getElementById("km"+orden).value;
  p_desde=document.getElementById("p_desde"+orden).innerHTML;
  p_hasta=document.getElementById("p_hasta"+orden).innerHTML;
  eje("vl_gd?pd="+p_desde+"&ph="+p_hasta+"&km="+km);
}
...
<h6>Distancia por tramo</h6>
<div class="table-responsive">
      <table  class="table table-borderless" id="tdista" onfocus="distancias()">
        <thead class="table-success">
          <tr><th>Desde</th><th>Hasta</th><th>Km</th></tr>
        </thead>
        <tbody id="">
          <tr><td id='p_desde1'></td><td id='p_hasta1'></td><td>
            <input class='form-control col-md-2' id='km1' maxlength="6" onblur='sale_km(this.id)'></td></tr>
          <tr><td id='p_desde2'></td><td id='p_hasta2'></td><td>
            <input class='form-control col-md-2' id='km2'  maxlength="6" onblur='sale_km(this.id)'></td></tr>
          </td></tr>
          <tr><td id='p_desde3'></td><td id='p_hasta3'></td><td>
            <input class='form-control col-md-2' id='km3' maxlength="6" onblur='sale_km(this.id)'></td></tr>
          </td></tr>
          <tr><td id='p_desde4'></td><td id='p_hasta4'></td><td>
            <input class='form-control col-md-2' id='km4' maxlength="6" onblur='sale_km(this.id)'></td></tr>
          </td></tr>
...
function sale_km(id){
  orden=der(id,1);
  desde=document.getElementById("p_desde"+orden).innerHTML;
  hasta=document.getElementById("p_hasta"+orden).innerHTML;
  if(desde!="" && hasta!=""){
    valida_dec(id);
  }
  else{

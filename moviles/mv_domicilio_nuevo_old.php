...
function norma(){
 ...
 var xhttp = new XMLHttpRequest();
  ...
  xhttp.open("GET", "https://servicios.usig.buenosaires.gob.ar/normalizar/?direccion="+t+"&maxOptions=25&geocodificar=true", false);
  xhttp.send();
...
xhttp2.open("GET", "https://ws.usig.buenosaires.gob.ar/datos_utiles?x="+x+"&y="+y, true);
xhttp2.send();
return true;
}
...
<form  class="form" method="get" onsubmit="return valida_formulario()" action="mv_domicilio_nuevo_do">
    ...
    <div class="form-group col-md-6 has-warning">
        ...
        <input class="form-control" id="entrada" name="entrada" size="50" maxlength="150" onblur="norma()" value="<?php echo $t?>" autofocus required>
    </div>
...
<div class="row">
    <div class="form-group has-warning col-md-6">
        ...
        <input class="form-control" id="direccion" name="direccion" size="70"  required onblur="dupli()">
    </div>
</div>
<div class="row">
    ...
    <div class="form-group has-warning col-md-4">
        ...
        <input class="form-control" id="calle" name="calle"  required>
    </div>
    <div class="form-group has-warning col-md-4">
    ...
    <div class="form-group has-warning col-md-4">
        ...
        <input class="form-control" id="calle_cruce" name="calle_cruce" >
    </div>
    <div class="form-group has-warning col-md-6">
        <label class="label-form">Localidad</label>
        <input class="form-control" id="localidad" name="localidad"  required>
    </div>
    <div class="form-group has-warning col-md-6">
        <label class="label-form">Partido</label>
        <input class="form-control" id="partido" name="partido"  required>
    </div>
    <div class="form-group has-warning col-md-6">
        <label class="label-form">Barrio</label>
        <input class="form-control" id="barrio" name="barrio" >
    </div>
    <div class="form-group has-warning col-md-6">
  ...
  <div class="row">
    ...
    <div class="form-group has-warning col-md-6">
        <a class="btn btn-info" id="nnn" name="nnn" value="1" href="javascript:nnn1()">Domicilio no normalizado</a>
    </div>    
</div>
</form>

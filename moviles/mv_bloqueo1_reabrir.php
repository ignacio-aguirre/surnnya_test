...
if($cntb1>0)	{
  ejecute("update movil_viajes 
	set movil_viajes.bandeja=1,f_solicitud=".$_SESSION["hoy_s"].",bloqueo=0 where movil_viajes.bandeja=6 and 	fecha between	".$desdes." and ".$hastas);
}

ejecute("update movil_procesos set b1_6=0 where id=".$_SESSION["idproceso"]);



$_SESSION["msg"]="Bloqueo 1 revertido";

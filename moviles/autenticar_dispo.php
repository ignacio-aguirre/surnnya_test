...
ejecute("update movil_usuarios set c_autenticacion=".tsql($codigo)." where id=".$idusua);
error_reporting(E_STRICT);
require '../vendor/autoload.php';
$mail = new PHPMailer\PHPMailer\PHPMailer(true);$mail->IsSMTP(); // telling the class to use SMTP
...
$reg=un_registro("select  * from movil_usuarios where id=".$_SESSION["usuario"]);
if($reg["id"]>"0"){

...
session_start();
$_SESSION["prestacion"]="Editar datos de sector";
include("encabezado.php");
$id=nget("id");
$d=un_registro("select * from sectores where id=".$id);
?>
</div>
<br>
<div class="container">
    <div class="row">
        <h4 class="col-md-12">Datos de <?php echo $d["denominacion"]?></h4>
    </div>
    <form class="form" onsubmit="return valida_formulario()" method="get" action="mv_sector_editar_do">

...
<html>
<head>
<title>Carga de datos de un nuevo Usuario</title>
...
</td><td><input id="email" name="email" size="40" maxlength="45" onblur="valida_mail(this.id)"></td></tr>
...
<tr><td><input id="reparticion" name="reparticion" size="15" maxlength="15" onblur="valida_0(this.id)"></td><td><input id="sector" name="sector" size="15" maxlength="15" onblur="valida_0(this.id)"></td>
<td><input id="grupal" name="grupal" size="1" maxlength="1" onblur="valida_entero(this.id)"></td>
<td><input id="carga" name="carga" size="1" maxlength="1" onblur="valida_entero(this.id)"></td>
<td><input id="sistema" name="sistema" size="1" maxlength="1" onblur="valida_entero(this.id)"></td>
</tr>

...
<div class="container">
<strong>NNYA con Solicitudes Abiertas</strong>
...
<?php
 ...
 where sujetos.legajo in (select distinct es_participaciones.legajo from es_participaciones where fecha_inicio is not null and fecha_fin is null)
...
function accion(legajo){
 navega("es_sol_legajo?legajo="+legajo);
}
</script>
</body>

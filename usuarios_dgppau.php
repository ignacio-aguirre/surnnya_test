...
$sql="select usuarios.id, apellido as apel, usuarios.nombre as nomb, cuil, sectores.denominacion as ndispo, perfiles.denominacion as nperfil, usuarios.email, intentos 
	...
	where usuarios.baja is null and (sectores.denominacion like '%DGPPAU%')";
...
<button onclick='navega("usuario_dgppau_nuevo")' class='btn-primary'>Nuevo</button>&nbsp;&nbsp;<br>
<div class="table-responsive pre-scrollable">
<table class="table table-striped">
<tr class="bg-success" style="font-size:.8em"><th><a href='usuarios_dgppau'>Apellido y Nombre</a></th><th>CUIL</th><th><a href='usuarios_dgppau?orden=dispo'>Sector<a></th><th><a href='usuarios_dgppau?orden=perfil'>Perfil</a></th><th>Intentos</th><th>Acciones</th></tr>
<?php
while	($u = mysqli_fetch_assoc($usu)) 
	...
	$url_aux="unusuario_dgppau?vusuario=".$u['id'];	
		echo "<td><a href='".$url_aux."'> Editar </a>&nbsp;&nbsp;&nbsp;";
	$url_aux="usuario_dgppau_elimina?vusuario=".$u['id'];	

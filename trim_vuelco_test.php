...
<div class="container">
<form class="form-inline" method="get" action="trim_vuelco_excel_test">
...
<div class="form-group has-warning">
  <label class="label-form">Conjunto</label>
  <select class="form-control" name="conjunto">
   <option value="">Todos</option>
   <option value="identidad">Identidad</option>
   <option value="admlegal">Adm.Legal</option>

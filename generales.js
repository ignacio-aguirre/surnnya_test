...
if(ano<1930||ano>2040||mes<1||mes>12||dia<1||dia>31) return false;
...
if (!(texto.length==10)) { 
   ...
   else if((texto.length==6) && (fvalida(texto.substr(0,2),texto.substr(2,2),"20" + texto.substr(4,2))) && (texto.substr(4,2)<="27"))  {cosa.value=texto.substr(0,2) + "/" + texto.substr(2,2) + "/" + "20" + texto.substr(4,2);} 
   else if((texto.length==6) && (fvalida(texto.substr(0,2),texto.substr(2,2),"19" + texto.substr(4,2))) && (texto.substr(4,2)>"27"))  {cosa.value=texto.substr(0,2) + "/" + texto.substr(2,2) + "/" + "19" + texto.substr(4,2);} 
...
function ajax(url,tipo,parametros){
...
function ejec_n(url){
    pet = new XMLHttpRequest();
    pet.onreadystatechange = finEjec;
    pet.open('GET', url, true);
    pet.send(null);
}

...
$id=un_campo("select id from trim_actividades where anio=".$anio." and trimestre=".$trimestre." and legajo=".$nnya." and hogar=".$hogar);
if(!$id>0) $id=inserte("insert into trim_actividades(anio,trimestre,legajo,hogar,trimestral) values(".$anio.",".$trimestre.",".$nnya.",".$hogar.",".$trimestral.")");
...
ejecute("update trim_actividades set 
institucion=".$tra_institucion.",
tipo_actividad=".$tra_tipo_actividad.",
actividad=".$tra_actividad.",
frecuencia=".$tra_frecuencia.",
institucion2=".$tra_institucion2.",
tipo_actividad2=".$tra_tipo_actividad2.",
actividad2=".$tra_actividad2.",
frecuencia2=".$tra_frecuencia2.",
observaciones=".$tra_observaciones.",
usuario=".$_SESSION["usuario"].",fecha=curdate(), trimestral=".$trimestral." where id=".$id);
Redirect("transicion?proximo=vinculaciones&id=".$trimestral);
?>
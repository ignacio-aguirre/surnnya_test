...
<div class="container">
<strong>Solicitudes Abiertas a Asignar</strong>
<div class='table-responsive'>
<table class='table table-striped table-bordered'>
<tr><th>Fecha</th><th>Apellido y Nombre, edad</th><th>Solicitante</th><th>Profesi&oacute;n</th><th>Ult.Acci&oacute;n</th><th>Opciones</th></tr>
<?php
 ...
 where fecha_rechazo is null and fecha_fin is null and es_profesionales.id is null order by apellidos, nombres, fecha_ingreso asc";
   $reg =registros($sql);
   $conta=0;
...
function profesional(id){
 navega("es_solicitud_profesional?id="+id+"&retorno=asignar");
}
